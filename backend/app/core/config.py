...
class Settings(BaseSettings):
    ...
    AUTH_SESSION_IDLE_TIMEOUT_MINUTES: int = 120
    ...
    AUGMIS_WEB_FETCH_MAX_BYTES: int = 900000
    ...
    AUGMIS_WEB_DISCOVERY_DEFAULT_MAX_HTML_RESPONSE_BYTES: int = 2000000
    AUGMIS_WEB_DISCOVERY_MAX_HTML_RESPONSE_BYTES: int = 5000000
