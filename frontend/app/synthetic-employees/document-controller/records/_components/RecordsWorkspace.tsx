...
export type RecordsColumn<RowType> = {
  key: string;
  label: string;
...
type RecordsWorkspaceProps<RowType> = {
  activeMenu: string;
  accentLabel: string;
  bodyTopContent?: ReactNode;
  cardDescription: string;
  cardTitle: string;
  columns: RecordsColumn<RowType>[];
  countLabel: string;
  emptyMessage: string;
  error?: ReactNode;
  loading?: boolean;
  metrics: RecordsMetricCard[];
...
const TOP_MENU_ITEMS = [
  { key: "overview", label: "Overview", href: "/synthetic-employees/document-controller/records" },
  {
    key: "active-records",
  ...
  {
    key: "archive-transfers",
    label: "Archive Transfers",
    href: "/synthetic-employees/document-controller/archive-transfers",
  },
] as const;

function resolveCellTitle<RowType>(column: RecordsColumn<RowType>, row: RowType) {
...
export function RecordsWorkspace<RowType>({
  activeMenu,
  accentLabel,
  bodyTopContent,
  cardDescription,
