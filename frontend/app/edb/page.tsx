...
//   { label: "Executive Dashboard", href: "/edb", icon: <DashboardCustomizeOutlinedIcon fontSize="small" />, active: true },
//   { label: "AI Co-Pilot", href: "/copilot", icon: <Groups2OutlinedIcon fontSize="small" /> },
//   { label: "Enterprise Search", href: "/search", icon: <SearchOutlinedIcon fontSize="small" /> },
//   { label: "Business Area Intelligence", href: "/business-areas", icon: <BusinessCenterOutlinedIcon fontSize="small" /> },
//   { label: "Reports", href: "/reports", icon: <AssessmentOutlinedIcon fontSize="small" /> },
//   { label: "Settings", href: "/settings", icon: <SettingsOutlinedIcon fontSize="small" /> },
//   { label: "Escalations", href: "/escalations", icon: <ReportProblemOutlinedIcon fontSize="small" /> },
//   { label: "Document Intelligence", href: "/documents", icon: <DescriptionOutlinedIcon fontSize="small" /> },
// ];
...
//             {label}
//           </Typography>
//           <Typography sx={{ fontSize: "2.05rem", lineHeight: 1, fontWeight: 800, color: "#1f2937" }}>
//             {value}
//           </Typography>
...
//               <Box sx={{ width: 9, height: 9, borderRadius: "999px", bgcolor: item.color }} />
...
//             <Box sx={{ width: 10, height: 10, borderRadius: "999px", bgcolor: item.color, flexShrink: 0 }} />
...
//   const [riskTableBusinessAreaFilter, setRiskTableBusinessAreaFilter] = useState("All");
//   const [riskTableLevelFilter, setRiskTableLevelFilter] = useState("All");
//   const sidebarWidth = collapsed ? 92 : 250;
...
//       value: totalRepositoryItems,
//       caption: "Records available from tenant repositories",
//       accent: "#2d62f1",
//     },
//     {
...
//   if (loading) {
//     return (
//       <Box sx={{ height: "calc(100vh - 97px - 32px)", minHeight: 0, display: "grid", placeItems: "center" }}>
...
//   return (
//     <Box sx={{ height: "calc(100vh - 97px - 32px)", minHeight: 0, overflow: "hidden" }}>
//       <Box
//         sx={{
//           height: "100%",
//           minHeight: 0,
//           display: "grid",
//           gridTemplateColumns: { xs: "1fr", lg: `${sidebarWidth}px minmax(0, 1fr)` },
//           gap: 2,
//           alignItems: "stretch",
//         }}
//       >
//         <SurfaceCard sx={{ display: "flex", flexDirection: "column", minHeight: 0 }}>
//           <Box
//             sx={{
//               height: 39,
//               bgcolor: BLUE,
...
//               Menu
//             </Typography>
//             <Tooltip title={collapsed ? "Expand menu" : "Collapse menu"} placement="left">
//               <IconButton
//                 size="small"
//                 onClick={() => setCollapsed((current) => !current)}
//                 sx={{ color: "#fff", borderRadius: `${CARD_RADIUS}px`, p: 0.35 }}
//               >
...
//           <Box sx={{ p: 1.0, display: "flex", flexDirection: "column", minHeight: 0, flex: 1 }}>
//             <List sx={{ px: 0, py: 0, flex: 1, minHeight: 0 }}>
//               {menuItems.map((item) => (
//                 <Tooltip key={item.label} title={collapsed ? item.label : ""} placement="right" disableHoverListener={!collapsed}>
//                   <ListItemButton
//                     component={Link}
//                     href={item.href}
...
//                       color: item.active ? "#183b7a" : "#415064",
//                       bgcolor: item.active ? "rgba(24, 59, 122, 0.08)" : "transparent",
//                       border: item.active ? "1px solid rgba(24, 59, 122, 0.12)" : "1px solid transparent",
//                       "&:hover": { bgcolor: "rgba(24, 59, 122, 0.08)", borderColor: "rgba(24, 59, 122, 0.14)" },
//                     }}
//                   >
...
//         <SurfaceCard sx={{ display: "flex", flexDirection: "column", minHeight: 0, height: "100%" }}>
//           <Box
//             sx={{
//               height: 39,
//               bgcolor: BLUE,
...
//           <Box sx={{ p: 2, display: "flex", flexDirection: "column", minHeight: 0, flex: 1, overflowY: "auto" }}>
//             <SurfaceCard sx={{ p: 2, mb: 2, bgcolor: "#fbfcff", flexShrink: 0 }}>
...
//                 <Chip label={`Risk: ${riskFilter}`} sx={{ borderRadius: `${CARD_RADIUS}px`, bgcolor: "#eef2ff", color: "#334155", fontWeight: 700 }} />
//                 <Chip label={`Date Range: ${dateRangeFilter}`} sx={{ borderRadius: `${CARD_RADIUS}px`, bgcolor: "#eef2ff", color: "#334155", fontWeight: 700 }} />
//               </Stack>
//             </SurfaceCard>
...
//                 <SurfaceCard key={panel.title} sx={{ p: 1.8, bgcolor: "#fbfcff", display: "flex", flexDirection: "column", flexShrink: 0, minHeight: 300 }}>
//                   <Box
//                     sx={{
//                       display: "flex",
//                       alignItems: "center",
...
//                     </TableHead>
//                     <TableBody>
//                       {filteredRiskSignalRows.slice(0).map((row, index) => (
